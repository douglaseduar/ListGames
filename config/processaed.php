...
$result_usuario = "UPDATE jogo SET nome='$nome', corp='$corp', progresso='$progressoaux', imagem='$imagem', plataforma='$plataformaaux', valor='$valoraux', tempo='$tempoaux' WHERE id='$id'";
